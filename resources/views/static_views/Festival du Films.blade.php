...
#header {
height: 245px;   background: url(img/banniere/festivaldufilm.png) center center / cover no-repeat;
}
</style>
...
<div class="row">
    ...
    <div class="col-lg-9">
        ...
        <div class="col-lg-1">  </div>
             <div class="col-lg-4">  <img src="img/logo/cnci.png" alt="cnci"></div>
        <div class="col-lg-4">  <img src="img/logo/32.png" alt="cinematheque"></div></div>
    <h2 class="soustitreprog"style="margin-top:10%" > |  Festival du Films
</h2>
       <div class="soustitreprog">

       <p>

       INSANIYYAT & la Cinémathèque de Tunis organisent un festival de films à la Cité de la Culture, du 20 au 25 septembre 2022.
Deux thèmes sont retenus pour la programmation :<br>

CriseS et Films arabes et africains.
<b>Les projections auront lieu à 14h30, 17h30, 20h30.</b>
