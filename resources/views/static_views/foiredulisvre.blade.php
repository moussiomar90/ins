                    ...
                    <div class="header__nav__option">
                        <nav class="header__nav__menu mobile-menu">
                            <ul>
                                ...
                                <li class="active"><a >Activités culturelles  </a><ul class="dropdown">
...
#header {
height: 245px;   background: url(img/banniere/foiredulivre.png) center center / cover no-repeat;
}
</style>
...
<div class="row">
    ...
    <h2 class="soustitreprog" > | Deux expositions de livres seront organisées :
</h2>
       <div class="soustitreprog">

       <p>

       -l'une, sur le site du Campus universitaire de la Manouba, constitue un panorama des publications scientifiques éditées par les universités tunisiennes organisatrices et partenaires du Forum <br>
-l'autre, dans les locaux de la Cité de la Culture, s'étend à l'ensemble de la production livresque dans toutes ses variantes et langues : romans, essais, poésies, biographies, ouvrages d'art, bandes dessinées, livres de loisirs, littérature pour enfants, revues, magazines... <br>

CriseS et Films arabes et africains.
